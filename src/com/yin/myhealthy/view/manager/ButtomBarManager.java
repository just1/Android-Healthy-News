...
public class ButtomBarManager {
	// 单例模式
		...
		public void init(Activity activity) {
			...
			imbtn_medicine = (ImageButton) activity.findViewById(R.id.imgbtn_bottombar_medicine);
			imbtn_knowledge = (ImageButton) activity.findViewById(R.id.imgbtn_bottombar_knowledge);
